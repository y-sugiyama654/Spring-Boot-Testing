...
import net.javaguides.springboottesting.integration.AbstractionBaseTest;
...
public class EmployeeRepositoryIT extends AbstractionBaseTest {
    ...
    public void givenFirstNameAndLastName_whenFindByNativeSQLNamedParams_thenReturnEmployee() {
        ...
        // when - action or the behaviour that we are going test
        Employee findEmployee = employeeRepository.findByNativeSQLNamedParams(firstName, lastName);
